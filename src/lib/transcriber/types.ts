...
export const VERTEX_MODELS: ModelInfo[] = [
  ...
  {
    id: 'gemini-3.1-flash-vertex',
    name: 'Gemini 3.1 Flash (Vertex)',
    provider: 'vertex',
    description: 'Fast and cost-effective latest-generation Vertex model. Good for long recordings.',
    maxAudioLength: 7200,
    supportsDiarization: true,
    supportsTimestamps: true,
    tierInfo: 'Paid (billing-enabled project required)',
  },
  {
    ...
    provider: 'vertex',
    description: 'Powerful latest-generation Vertex model for difficult or noisy recordings.',
    maxAudioLength: 7200,
    supportsDiarization: true,
    supportsTimestamps: true,
    tierInfo: 'Paid (billing-enabled project required)',
