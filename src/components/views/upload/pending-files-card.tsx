...
import { UploadWarning, UploadError } from './upload-messages';
...
export function PendingFilesCard({ files, checking, preflightWarning, error, onClearAll, onRemoveFile, onAddMore, onStart }: PendingFilesCardProps) {
  return (
    <>
      <Card>
      ...
      {preflightWarning && <UploadWarning message={preflightWarning} />}
