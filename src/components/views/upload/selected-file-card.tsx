...
import { UploadWarning } from './upload-messages';
...
export function SelectedFileCard({ fileName, fileSize, checking, preflightWarning, onRemove, onStart }: SelectedFileCardProps) {
  return (
    <>
